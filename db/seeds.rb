...
employer1 = Employer.create(username: "brianafaror", password: "1111", password_confirmation: "1111", name: "Briana Faror", bio: bio_text, img_url: "briana_faror.jpeg", status: "employer")
...
caregiver2 = Caregiver.create(username: "ninatalbot", password: "1111", password_confirmation: "1111", name: "Nina Talbot", bio: bio_text, img_url: "nin_talbot.jpeg", status: "caregiver")
...
job3 = employer2.jobs.create(title: "Pets need feeding this week!", category: "Pets", salary: "200", salary_type: "Flat Rate", date: "Tues Aug 10 2021 at 2:00PM-Sat Aug 14 2021 at 4:00PM")
job4 = employer2.jobs.create(title: "Help for date night", category: "Children", salary: "10", salary_type: "Per Hour", date: "Tues Aug 31 2021 at 7:00PM-Tues Aug 31 2021 at 11:00PM")
