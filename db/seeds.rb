...
caregiver2 = Caregiver.create(username: "violettajackson", password: "1111", password_confirmation: "1111", name: "Violetta Jackson", bio: bio_text, img_url: "violetta_larivi.jpeg", status: "caregiver")
...
job3 = employer1.jobs.create(title: "Pets need feeding this week!", category: "Pets", salary: "200", salary_type: "Flat Rate", date: "Tues Aug 10 2021 at 2:00PM-Sat Aug 14 2021 at 4:00PM", caregiver_id: caregiver2.id)
job4 = employer3.jobs.create(title: "Help for date night", category: "Children", salary: "10", salary_type: "Per Hour", date: "Tues Aug 31 2021 at 7:00PM-Tues Aug 31 2021 at 11:00PM", caregiver_id: caregiver3.id)
job5 = employer3.jobs.create(title: "Need babysitter after school", category: "Children", salary: "10", salary_type: "Per Hour", date: "Wed Aug 25 2021 at 2:00PM-Wed Aug 25 2021 at 6:00PM")
job7 = employer3.jobs.create(title: "Housesitting for vacation", category: "House", salary: "350", salary_type: "Flat Rate", date: "Sun Sept 5 2021 at 2:00PM-Fri Sept 10 2021 at 6:00PM")